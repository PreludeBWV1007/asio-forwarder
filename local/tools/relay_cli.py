...
用法示例：
  PYTHONPATH=local/tools python3 local/tools/relay_cli.py --host 127.0.0.1 --port 19000
...
def main() -> int:
    ...
    ap.add_argument(
        "--config",
        default="deliver/server/forwarder.json",
        help="spawn-server 用的基础配置文件（相对仓库根）",
    )
    args = ap.parse_args()
