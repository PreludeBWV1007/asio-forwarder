...
对应实现：`deliver/server/src/main.cpp`、`deliver/client/include/fwd/protocol.hpp`、`deliver/client/include/fwd/relay_constants.hpp`、`deliver/client/include/fwd/sha256.hpp`。
...
- **Header.flags**：位定义存在于 `deliver/client/include/fwd/protocol.hpp`，当前主路径**不依赖 flags** 做路由。
...
详细字段见 **[protocol.md](protocol.md)**；Python 参考 **[client_api.md](client_api.md)**、**`local/tools/relay_client.py`**；本地测试与回归见 **[local.md](local.md)**。
