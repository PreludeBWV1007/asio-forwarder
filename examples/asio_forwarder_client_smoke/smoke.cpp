// =============================================================================
// asio_forwarder_client_smoke —— 给「自测/回归」用的小程序（不是给最终用户安在产品里的东西）
//
// 你要加自己的黑盒测什么？
//   · 最省事：改/扩本文件里的 smoke_test()，在对应步骤旁加断言语句或新代码块。
//   · 想干净拆开：同目录下新建 your_case.cpp，CMake 里再加一个 add_executable，链 asio_forwarder_sdk。
//   · API 在 include/fwd/asio_forwarder_client.hpp ；多进程大示例另见 examples/realistic_scenario_cpp/ 。
// =============================================================================
...
void print_usage() {
  std::cerr << "asio_forwarder_client_smoke\n"
