...
```bash
python3 examples/realistic_scenario/dispatcher.py --host 127.0.0.1 --port 19000
python3 examples/realistic_scenario/worker.py --host 127.0.0.1 --port 19000 --username worker1
python3 examples/realistic_scenario/admin.py --host 127.0.0.1 --port 19000
```
